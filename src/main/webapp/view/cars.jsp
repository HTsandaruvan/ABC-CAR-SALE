        ...
        <div class="d-flex">
          ...
          <div class="car-list">
            ...
            <div class="mt-4 row">
                ...
                <c:forEach items="${listCar}" var="car">
                  <c:if test="${car.status.equals('ACTIVE')}">
                    <div class="col-12 col-md-6 col-md-4 col-lg-3 mb-3">
                      <div class="card">
                        <img height="300px" class="card-img-top" src="data:${car.carPicture.fileType};base64,${car.carPicture.image}" alt="${car.make}" />
                        <div class="card-body">
              ...
              <c:if test="${listCar.isEmpty()}">
                <h4 class="fw-bold text-white text-center">Car not found</h4>
              </c:if>
            </div>
          </div>
        </div>
