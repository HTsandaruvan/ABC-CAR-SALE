          ...
          <div class="content-wrapper">
            <div class="user d-flex justify-content-between">
              <div class="d-flex flex-column flex-md-row">
                ...
                <div class="user-details pt-4">
                  <h5 class="fw-semibold text-white">${profile.firstName} ${profile.lastName}</h5>
                  <p class="text-white m-0">${profile.phoneNumber}</p>
                  <p class="text-white m-0">${profile.address}</p>
                </div>
              </div>
              <div class="pt-4">
                <a href="<%= request.getContextPath() %>/user/edit-profile">
                  <button class="btn btn-outline-info text-white">Edit Profile</button>
                </a>
              </div>
            </div>
            <!-- About -->
            <c:if test="${profile.about != null}">
              <div class="about mt-3">
                <h5 class="fw-semibold text-white" >About Me</h5>
