		...
		<div class="container pt-5">
			<div class="d-flex">
				...
				<aside class="sidebar-user pe-md-3">
					<ul>
						...
						<li class="active-page"><a
							href="<%=request.getContextPath()%>/user/my-posted-car"><i
								class="fa-solid fa-car"></i> My Posted Car</a></li>
						<li><a href="<%=request.getContextPath()%>/user/test-drive"><i
				...
				<div class="content-wrapper">
											...
											<c:if test="${!car.status.equals('SOLD')}">
												<td>
													<div class="dropdown">
														...
														<ul>
															<li><a
																href="<%= request.getContextPath() %>/cars/${car.make}/${car.model}/${car.year}/${car.idCar}">Car
																	Details</a></li>
															<li><a class="dropdown-item"
																href="<%= request.getContextPath() %>/user/edit-posted-car?id=${car.idCar}">Edit
																	Details</a></li>
															<li><a class="dropdown-item"
																href="<%= request.getContextPath() %>/user/upload-car-picture?idCar=${car.idCar}">Edit
																	Picture</a></li>
															<c:if test="${car.status.equals('ACTIVE')}">
																<li><a class="dropdown-item"
																	href="<%= request.getContextPath() %>/user/deactivate/${car.idCar}">Deactivate
																		Post</a></li>
															</c:if>
															<c:if test="${car.status.equals('DEACTIVE')}">
																<li><a class="dropdown-item"
																	href="<%= request.getContextPath() %>/user/activate/${car.idCar}">Activate
																		Post</a></li>
															</c:if>
														</ul>
												</div>
					...
					<c:if test="${userCar.isEmpty()}">
						<p class="text-white">You have not posted any cars yet. Want
							to sell your car?</p>
