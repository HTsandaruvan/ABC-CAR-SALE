		...
		<div class="wrapper">
			<div class="inner">
				<div class="image-holder">
					<img src="/images/background/sale-car.jpg" alt="" style="height:600px;width: 400px;">
				</div>
				<form:form action="postCarProcess" method="POST"
					enctype="multipart/form-data" modelAttribute="car">
					<h3 class="holder">Sale A Car</h3>
					...
					<small><form:errors style="margin-left: 80px;" path="year"
							cssClass="error" /></small>
					<label class="form-label " style="margin-left: 80px;" >Price ($)</label>
					...
					<small><form:errors style="margin-left: 80px;" path="price"
							cssClass="error" /></small>
					<label class="form-label " style="margin-left: 80px;" >Car Picture</label>
					<div class="form-row">
					...
					<button type="submit" style="margin-left: 170px;">
						Post <i class="zmdi zmdi-long-arrow-right"></i>
					</button>
