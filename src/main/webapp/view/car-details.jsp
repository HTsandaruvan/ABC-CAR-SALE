        ...
        <div class="d-flex">
          ...
          <aside class="sidebar-car me-sm-4 pt-3" >
            <ul class="fw-semibold">
              <li class="text-info ms-1">
                <a class="text-info" href="<%= request.getContextPath() %>/cars"><i class=" text-info fa-solid fa-car"></i> Car List</a>
              </li>
              <li>
                <a href="<%= request.getContextPath() %>/user/post-car">
                  <button class="btn btn-success">Post a car</button>
                </a>
              </li>
              <li>
                <p class="text-info ms-1"><i class="text-info fa-solid fa-dollar-sign"></i> Price Range</p>
          ...
          <div class="car-list">
            ...
            <div class="mt-4 row">
              ...
              <div class="car-details col-12 col-sm-4">
                <h4 class="fw-bold text-white">${car.make} ${car.model} ${car.year}</h4>
                <p class="text-white m-0">STARTING PRICE:</p>
                <p class="text-info fs-5">$${car.price}</p>
                <c:if test="${highestBidding != 0}">
                  <p class="text-white m-0">HIGHEST BID:</p>
                  <p class="text-info fs-5">$${highestBidding}</p>
                </c:if>
                <c:if test="${highestBidding == 0}">
                  <p class="text-white m-0">HIGHEST BID:</p>
                  <p class="text-info fs-5">$${highestBidding}</p>
                ...
                <div class="car-button-actions">
                  <a class="text-decoration-none" href="<%= request.getContextPath() %>/car-bid?id=${car.idCar}">
                    <button class="btn11-get-started scrollto">Place Bid</button>
                  </a>
                  <a class="text-decoration-none" href="<%= request.getContextPath() %>/test-drive/${car.idCar}">
                    <button class="btn btn-success">Test Drive</button>
                  </a>
                </div>
              </div>
            </div>
